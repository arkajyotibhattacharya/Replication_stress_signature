...
name_the_function = function(genes_of_interest, sub_summary_request = NULL)
{
  ...
  print(paste((proc.time()[3]-time1)/60,"mins to build dataset to push to limma"))
  TCGA_rnaseq_adjusted_for_limma = t(t_TCGA_rnaseq)
  
  design_vec= TCGA_rnaseq_adjusted_for_limma[dim(TCGA_rnaseq_adjusted_for_limma)[1],]
  TCGA_rnaseq_adjusted_for_limma = TCGA_rnaseq_adjusted_for_limma[-dim(TCGA_rnaseq_adjusted_for_limma)[1],]
  TCGA_rnaseq_adjusted_for_limma = TCGA_rnaseq_adjusted_for_limma[,which(!is.na(design_vec))]
